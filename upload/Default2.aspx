<%@ page language="C#" autoeventwireup="true" inherits="Default2, App_Web_l05oqfda" %>
...
<body>
    ...
    <div>
     <a href="vlsm.htm">Chia địa chỉ mạng</a><br />
        ...
        <a href="balo.aspx">Mã hóa sử dụng balo</a><br />
        <a href="Tinh_Trung_Vi.aspx">Tính trung vị</a><br />
        <br />
        <br />
        <br />
        <br />
